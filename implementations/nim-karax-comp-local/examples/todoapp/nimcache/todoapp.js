...
var selectedEntry_92006 = /**/[-1];
var filter_92007 = [0];
var entriesLen_92008 = [0];
...
function toClass_92105(completed_92107) {

var Tmp1;
var result_92108 = null;
if (completed_92107) {
Tmp1 = "completed";
}
else {
...
function toChecked_92110(checked_92112) {

var Tmp1;
var result_92113 = null;
if (checked_92112) {
Tmp1 = "checked";
}
else {
...
function markAsCompleted_92033(pos_92035, value_92036) {
...
localStorage.setItem(toJSStr((cstrToNimstr((pos_92035)+"").slice(0,-1)).concat(makeNimstrLit("bool"))), val_92037);
}
function isCompleted_92024(pos_92026) {

var result_92027 = false;
var value_92028 = localStorage.getItem(toJSStr((cstrToNimstr((pos_92026)+"").slice(0,-1)).concat(makeNimstrLit("bool"))));
result_92027 = (value_92028 == "true");
return result_92027;
}
function toggleEntry_92077(ev_92079, n_92080) {

var id_92081 = n_92080.key;
markAsCompleted_92033(id_92081, !(isCompleted_92024(id_92081)));
}
function editHandler_92065(ev_92067, n_92068) {

selectedEntry_92006[0] = n_92068.key;
}
...
function setEntryCstring_92029(pos_92031, value_92032) {

localStorage.setItem(toJSStr((cstrToNimstr((pos_92031)+"").slice(0,-1)).concat(makeNimstrLit("cstring"))), value_92032);
}
function updateEntry_92051(pos_92053, str_92054, bval_92055) {

setEntryCstring_92029(pos_92053, str_92054);
markAsCompleted_92033(pos_92053, bval_92055);
}
function removeHandler_92060(ev_92062, n_92063) {

updateEntry_92051(n_92063.key, null, false);
}
function focusLost_92069(ev_92071, n_92072) {

selectedEntry_92006[0] = -1;
}
function editEntry_92073(ev_92075, n_92076) {

setEntryCstring_92029(n_92076.key, value_76508(n_92076));
selectedEntry_92006[0] = -1;
}
...
function innercreateEntry_92128(id_92130, d_92131, completed_92132, selected_92133) {

var result_92134 = null;
var tmp_92147 = tree_76856(94, []);
var tmp_92153 = tree_76856(35, []);
tmp_92153.class = toClass_92105(completed_92132);
if (!(selected_92133)) {
var tmp_92159 = tree_76856(41, []);
tmp_92159.class = "view";
var tmp_92165 = tree_76856(101, []);
tmp_92165.class = "toggle";
setAttr_76718(tmp_92165, "type", "checkbox");
setAttr_76718(tmp_92165, "checked", toChecked_92110(completed_92132));
addEventHandler_90409(tmp_92165, 0, toggleEntry_92077);
tmp_92165.key = id_92130;
add_76837(tmp_92159, tmp_92165);
var tmp_92172 = tree_76856(100, []);
addEventHandler_90409(tmp_92172, 1, editHandler_92065);
tmp_92172.key = id_92130;
add_76837(tmp_92172, text_76935(d_92131));
add_76837(tmp_92159, tmp_92172);
var tmp_92179 = tree_76856(102, []);
tmp_92179.class = "destroy";
tmp_92179.key = id_92130;
addEventHandler_90409(tmp_92179, 0, removeHandler_92060);
add_76837(tmp_92159, tmp_92179);
add_76837(tmp_92153, tmp_92159);
}
else {
var tmp_92186 = tree_76856(101, []);
tmp_92186.class = "edit";
setAttr_76718(tmp_92186, "name", "title");
tmp_92186.key = id_92130;
addEventHandler_90409(tmp_92186, 5, focusLost_92069);
addEventHandler_90409(tmp_92186, 22, editEntry_92073);
valueeq__76512(tmp_92186, d_92131);
setFocus_89025(tmp_92186);
add_76837(tmp_92153, tmp_92186);
}

add_76837(tmp_92147, tmp_92153);
result_92134 = tmp_92147;
return result_92134;
}
...
function createEntry_92196(args_92199) {

var result_92200 = null;
result_92200 = innercreateEntry_92128(intValue_76516(args_92199[0]), args_92199[1].text, !((intValue_76516(args_92199[2]) == 0)), !((intValue_76516(args_92199[3]) == 0)));
return result_92200;
}
vcomponents_87126[0]["createEntry"] = createEntry_92196;
function selected_92115(v_92117) {

var Tmp1;
var result_92118 = null;
if ((filter_92007[0] == v_92117)) {
Tmp1 = "selected";
}
else {
Tmp1 = null;
...
function clearCompleted_92086(ev_92088, n_92089) {
...
L2: do {
L3: while (true) {
if (!(i_92103 < entriesLen_92008[0])) break L3;
i_92099 = i_92103;
if (isCompleted_92024(i_92099)) {
setEntryCstring_92029(i_92099, null);
}
...
function innermakeFooter_92213(entriesCount_92215, completedCount_92216) {

var Tmp1;
var result_92217 = null;
var tmp_92234 = tree_76856(26, []);
tmp_92234.class = "footer";
var tmp_92240 = tree_76856(68, []);
tmp_92240.class = "todo-count";
var tmp_92246 = tree_76856(44, []);
add_76837(tmp_92246, text_76935(((entriesCount_92215)+'')));
add_76837(tmp_92240, tmp_92246);
if (!((entriesCount_92215 == 1))) {
...
add_76837(tmp_92240, text_76935((" item" + (toJSStr(Tmp1)))));
add_76837(tmp_92234, tmp_92240);
var tmp_92252 = tree_76856(34, []);
tmp_92252.class = "filters";
var tmp_92258 = tree_76856(35, []);
var tmp_92264 = tree_76856(42, []);
tmp_92264.class = selected_92115(0);
setAttr_76718(tmp_92264, "href", "#/");
add_76837(tmp_92264, text_76929(makeNimstrLit("All")));
add_76837(tmp_92258, tmp_92264);
add_76837(tmp_92252, tmp_92258);
var tmp_92270 = tree_76856(35, []);
var tmp_92276 = tree_76856(42, []);
tmp_92276.class = selected_92115(1);
setAttr_76718(tmp_92276, "href", "#/active");
add_76837(tmp_92276, text_76929(makeNimstrLit("Active")));
add_76837(tmp_92270, tmp_92276);
add_76837(tmp_92252, tmp_92270);
var tmp_92282 = tree_76856(35, []);
var tmp_92288 = tree_76856(42, []);
tmp_92288.class = selected_92115(2);
setAttr_76718(tmp_92288, "href", "#/completed");
add_76837(tmp_92288, text_76929(makeNimstrLit("Completed")));
add_76837(tmp_92282, tmp_92288);
add_76837(tmp_92252, tmp_92282);
add_76837(tmp_92234, tmp_92252);
var tmp_92294 = tree_76856(102, []);
tmp_92294.class = "clear-completed";
addEventHandler_90409(tmp_92294, 0, clearCompleted_92086);
add_76837(tmp_92294, text_76935((("Clear completed (" + ((completedCount_92216)+'')) + ")")));
add_76837(tmp_92234, tmp_92294);
result_92217 = tmp_92234;
return result_92217;
}
function makeFooter_92307(args_92310) {

var result_92311 = null;
result_92311 = innermakeFooter_92213(intValue_76516(args_92310[0]), intValue_76516(args_92310[1]));
return result_92311;
}
vcomponents_87126[0]["makeFooter"] = makeFooter_92307;
function addEntry_92038(str_92040, bval_92041) {

setEntryCstring_92029(entriesLen_92008[0], str_92040);
markAsCompleted_92033(entriesLen_92008[0], bval_92041);
entriesLen_92008[0] += 1;
}
function onTodoEnter_92056(ev_92058, n_92059) {

addEntry_92038(value_76508(n_92059), false);
valueeq__76512(n_92059, "");
}
function innermakeHeader_92324() {

var result_92326 = null;
var tmp_92335 = tree_76856(25, []);
tmp_92335.class = "header";
var tmp_92341 = tree_76856(19, []);
add_76837(tmp_92341, text_76929(makeNimstrLit("todos")));
add_76837(tmp_92335, tmp_92341);
var tmp_92347 = tree_76856(101, []);
tmp_92347.class = "new-todo";
setAttr_76718(tmp_92347, "placeholder", "What needs to be done?");
setAttr_76718(tmp_92347, "name", "newTodo");
addEventHandler_90409(tmp_92347, 22, onTodoEnter_92056);
setFocus_89025(tmp_92347);
add_76837(tmp_92335, tmp_92347);
result_92326 = tmp_92335;
return result_92326;
}
function makeHeader_92352(args_92355) {

var result_92356 = null;
result_92356 = innermakeHeader_92324();
return result_92356;
}
vcomponents_87126[0]["makeHeader"] = makeHeader_92352;
...
function colonanonymous__92486(hash_92488) {

if ((hash_92488 == "#/")) {
filter_92007[0] = 0;
}
else {
if ((hash_92488 == "#/completed")) {
filter_92007[0] = 2;
}
else {
if ((hash_92488 == "#/active")) {
filter_92007[0] = 1;
}
}}
}
setOnHashChange_90418(colonanonymous__92486);
entriesLen_92008[0] = 0;
...
function onAllDone_92082(ev_92084, n_92085) {

localStorage.clear();
selectedEntry_92006[0] = -1;
}
function getEntryCstring_92020(pos_92022) {

var result_92023 = null;
result_92023 = localStorage.getItem((((pos_92022)+'') + "cstring"));
if ((result_92023 == "null")) {
result_92023 = null;
}
...
function createDom_92369() {

var Tmp4;
var result_92371 = null;
var tmp_92386 = tree_76856(41, []);
tmp_92386.class = "todomvc-wrapper";
var tmp_92392 = tree_76856(15, []);
tmp_92392.class = "todoapp";
var tmp_92397 = vthunk_76549("makeHeader", []);
add_76837(tmp_92392, tmp_92397);
var tmp_92403 = tree_76856(15, []);
tmp_92403.class = "main";
var tmp_92409 = tree_76856(101, []);
tmp_92409.class = "toggle-all";
setAttr_76718(tmp_92409, "type", "checkbox");
setAttr_76718(tmp_92409, "name", "toggle");
add_76837(tmp_92403, tmp_92409);
var tmp_92415 = tree_76856(100, []);
setAttr_76718(tmp_92415, "for", "toggle-all");
addEventHandler_90409(tmp_92415, 0, onAllDone_92082);
add_76837(tmp_92415, text_76929(makeNimstrLit("Mark all as complete")));
add_76837(tmp_92403, tmp_92415);
var entriesCount_92417 = 0;
var completedCount_92418 = 0;
var tmp_92424 = tree_76856(34, []);
tmp_92424.class = "todo-list";
L1: do {
var i_92434 = 0;
var colontmp__92479 = 0;
colontmp__92479 = (entriesLen_92008[0] - 1);
var res_92482 = 0;
L2: do {
L3: while (true) {
if (!(res_92482 <= colontmp__92479)) break L3;
i_92434 = res_92482;
var d0_92435 = getEntryCstring_92020(i_92434);
var d1_92436 = isCompleted_92024(i_92434);
if (!((d0_92435 == null))) {
switch (filter_92007[0]) {
case 0: Tmp4 = true;

break;
case 1: Tmp4 = !(d1_92436);

break;
case 2: Tmp4 = d1_92436;

break;
}
var b_92437 = Tmp4;
if (b_92437) {
var tmp_92441 = vthunk_76549("createEntry", [vn_76520(i_92434), vn_76539(d0_92435), vn_76526(d1_92436), vn_76526((i_92434 == selectedEntry_92006[0]))]);
add_76837(tmp_92424, tmp_92441);
}

completedCount_92418 += (d1_92436 ? 1:0);
entriesCount_92417 += 1;
}
...
add_76837(tmp_92403, tmp_92424);
add_76837(tmp_92392, tmp_92403);
var tmp_92470 = vthunk_76549("makeFooter", [vn_76520(entriesCount_92417), vn_76520(completedCount_92418)]);
add_76837(tmp_92392, tmp_92470);
add_76837(tmp_92386, tmp_92392);
result_92371 = tmp_92386;
return result_92371;
}
setRenderer_90404(createDom_92369);
